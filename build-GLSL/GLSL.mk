...
all : \
	...
	$(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.inl \
...
$(SPIRV_DIR)/_internal_environment_lighting_skybox_vertex.inl $(SPIRV_DIR)/_internal_environment_lighting_skybox_vertex.d : $(SHADERS_DIR)/environment_lighting_skybox_vertex.bsl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es --target-env=vulkan1.0 -mfmt=num -fshader-stage=vert $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_environment_lighting_skybox_vertex.d" -o "$(SPIRV_DIR)/_internal_environment_lighting_skybox_vertex.inl" "$(SHADERS_DIR)/environment_lighting_skybox_vertex.bsl"

$(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.inl $(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.d : $(SHADERS_DIR)/environment_lighting_skybox_fragment.bsl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es --target-env=vulkan1.0 -mfmt=num -fshader-stage=frag $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.d" -o "$(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.inl" "$(SHADERS_DIR)/environment_lighting_skybox_fragment.bsl"
...
-include \
	...
	$(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.d \
...
clean:
	...
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.inl)
	...
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_environment_lighting_skybox_fragment.d)
