...
all : \
	...
	$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl \
	$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl \
	$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl \
...
$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl $(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d : $(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_clear_compute.bsl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=460core --target-env=vulkan1.0 -mfmt=num -fshader-stage=comp $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d" -o "$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_clear_compute.bsl"

$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl $(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d : $(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_equirectangular_map_compute.bsl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=460core --target-env=vulkan1.0 -mfmt=num -fshader-stage=comp $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d" -o "$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_equirectangular_map_compute.bsl"

$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl $(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d : $(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_octahedral_map_compute.bsl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=460core --target-env=vulkan1.0 -mfmt=num -fshader-stage=comp $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d" -o "$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_octahedral_map_compute.bsl"
...
$(SPIRV_DIR)/_internal_post_processing_vertex.inl $(SPIRV_DIR)/_internal_post_processing_vertex.d : $(SHADERS_DIR)/post_processing_vertex.bsl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es --target-env=vulkan1.0 -mfmt=num -fshader-stage=vert $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_post_processing_vertex.d" -o "$(SPIRV_DIR)/_internal_post_processing_vertex.inl" "$(SHADERS_DIR)/post_processing_vertex.bsl"
...
$(SPIRV_DIR)/_internal_post_processing_fragment.inl $(SPIRV_DIR)/_internal_post_processing_fragment.d : $(SHADERS_DIR)/post_processing_fragment.bsl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es --target-env=vulkan1.0 -mfmt=num -fshader-stage=frag $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_post_processing_fragment.d" -o "$(SPIRV_DIR)/_internal_post_processing_fragment.inl" "$(SHADERS_DIR)/post_processing_fragment.bsl"
...
-include \
	...
	$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d \
	$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d \
	$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d \
...
clean:
	...
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl)
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl)
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl)
	...
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d)
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d)
	$(HIDE) $(call host-rm,$(SPIRV_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d)
