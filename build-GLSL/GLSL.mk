...
$(SPIRV_DIR)/_internal_deforming_compute.inl $(SPIRV_DIR)/_internal_deforming_compute.d : $(SHADERS_DIR)/deforming_compute.sl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=460core --target-env=vulkan1.0 -mfmt=num -fshader-stage=comp $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_deforming_compute.d" -o "$(SPIRV_DIR)/_internal_deforming_compute.inl" "$(SHADERS_DIR)/deforming_compute.sl"
...
$(SPIRV_DIR)/_internal_post_processing_vertex.inl $(SPIRV_DIR)/_internal_post_processing_vertex.d : $(SHADERS_DIR)/post_processing_vertex.sl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es --target-env=vulkan1.0 -mfmt=num -fshader-stage=vert $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_post_processing_vertex.d" -o "$(SPIRV_DIR)/_internal_post_processing_vertex.inl" "$(SHADERS_DIR)/post_processing_vertex.sl"

$(SPIRV_DIR)/_internal_post_processing_fragment.inl $(SPIRV_DIR)/_internal_post_processing_fragment.d : $(SHADERS_DIR)/post_processing_fragment.sl
	$(HIDE) $(call host-mkdir,$(SPIRV_DIR))
	$(HIDE) "$(GLSL_COMPILER_PATH)" -std=310es --target-env=vulkan1.0 -mfmt=num -fshader-stage=frag $(GLSL_COMPILER_FLAGS) -MD -MF "$(SPIRV_DIR)/_internal_post_processing_fragment.d" -o "$(SPIRV_DIR)/_internal_post_processing_fragment.inl" "$(SHADERS_DIR)/post_processing_fragment.sl"
