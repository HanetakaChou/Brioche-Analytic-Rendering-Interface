...
$(DXIL_DIR)/_internal_deforming_compute.inl $(DXIL_DIR)/_internal_deforming_compute.d : $(SHADERS_DIR)/deforming_compute.sl
	$(HIDE) $(call host-mkdir,$(DXIL_DIR))
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -MD -MF "$(DXIL_DIR)/_internal_deforming_compute.d" -Fo "$(DXIL_DIR)/_internal_deforming_compute.inl" "$(SHADERS_DIR)/deforming_compute.sl"
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -Fh "$(DXIL_DIR)/_internal_deforming_compute.inl" -Vn "deforming_compute_shader_module_code" "$(SHADERS_DIR)/deforming_compute.sl"
...
$(DXIL_DIR)/_internal_post_processing_vertex.inl $(DXIL_DIR)/_internal_post_processing_vertex.d : $(SHADERS_DIR)/post_processing_vertex.sl
	$(HIDE) $(call host-mkdir,$(DXIL_DIR))
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T vs_6_8 -MD -MF "$(DXIL_DIR)/_internal_post_processing_vertex.d" -Fo "$(DXIL_DIR)/_internal_post_processing_vertex.inl" "$(SHADERS_DIR)/post_processing_vertex.sl"
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T vs_6_8 -Fh "$(DXIL_DIR)/_internal_post_processing_vertex.inl" -Vn "post_processing_vertex_shader_module_code" "$(SHADERS_DIR)/post_processing_vertex.sl"

$(DXIL_DIR)/_internal_post_processing_fragment.inl $(DXIL_DIR)/_internal_post_processing_fragment.d : $(SHADERS_DIR)/post_processing_fragment.sl
	$(HIDE) $(call host-mkdir,$(DXIL_DIR))
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T ps_6_8 -MD -MF "$(DXIL_DIR)/_internal_post_processing_fragment.d" -Fo "$(DXIL_DIR)/_internal_post_processing_fragment.inl" "$(SHADERS_DIR)/post_processing_fragment.sl"
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T ps_6_8 -Fh "$(DXIL_DIR)/_internal_post_processing_fragment.inl" -Vn "post_processing_fragment_shader_module_code" "$(SHADERS_DIR)/post_processing_fragment.sl"
