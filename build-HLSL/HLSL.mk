...
all : \
	...
	$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl \
	$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl \
	$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl \
...
$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl $(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d : $(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_clear_compute.bsl
	$(HIDE) $(call host-mkdir,$(DXIL_DIR))
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -MD -MF "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d" -Fo "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_clear_compute.bsl"
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -Fh "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl" -Vn "diffuse_environment_lighting_sh_projection_clear_compute_shader_module_code" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_clear_compute.bsl"

$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl $(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d : $(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_equirectangular_map_compute.bsl
	$(HIDE) $(call host-mkdir,$(DXIL_DIR))
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -MD -MF "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d" -Fo "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_equirectangular_map_compute.bsl"
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -Fh "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl" -Vn "diffuse_environment_lighting_sh_projection_equirectangular_map_compute_shader_module_code" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_equirectangular_map_compute.bsl"

$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl $(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d : $(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_octahedral_map_compute.bsl
	$(HIDE) $(call host-mkdir,$(DXIL_DIR))
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -MD -MF "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d" -Fo "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_octahedral_map_compute.bsl"
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T cs_6_8 -Fh "$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl" -Vn "diffuse_environment_lighting_sh_projection_octahedral_map_compute_shader_module_code" "$(SHADERS_DIR)/diffuse_environment_lighting_sh_projection_octahedral_map_compute.bsl"
...
-include \
	...
	$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d \
	$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d \
	$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d \
...
clean:
	...
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.inl)
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl)
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl)
	...
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_clear_compute.d)
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_equirectangular_map_compute.d)
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_diffuse_environment_lighting_sh_projection_octahedral_map_compute.d)
