...
all : \
	...
	$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.inl \
...
$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.inl $(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.d : $(SHADERS_DIR)/environment_lighting_skybox_fragment.bsl
	$(HIDE) $(call host-mkdir,$(DXIL_DIR))
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T ps_6_8 -MD -MF "$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.d" -Fo "$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.inl" "$(SHADERS_DIR)/environment_lighting_skybox_fragment.bsl"
	$(HIDE) "$(HLSL_COMPILER_PATH)" $(HLSL_COMPILER_DEBUG_FLAGS) -T ps_6_8 -Fh "$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.inl" -Vn "environment_lighting_skybox_fragment_shader_module_code" "$(SHADERS_DIR)/environment_lighting_skybox_fragment.bsl"
...
-include \
	...
	$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.d \
...
clean:
	...
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.inl)
	...
	$(HIDE) $(call host-rm,$(DXIL_DIR)/_internal_environment_lighting_skybox_fragment.d)
