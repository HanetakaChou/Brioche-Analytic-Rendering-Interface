...
#include "deforming_resource_binding.sli"
...
// note: when rendering, we should pack the deformed morph target 
...
{
    brx_uint max_vertex_count = brx_byte_address_buffer_get_dimension(g_surface_buffers[Deforming_Surface_Buffer_Vertex_Position_Index]) / g_surface_vertex_position_buffer_stride;
    ...
    brx_uint vertex_position_buffer_offset = g_surface_vertex_position_buffer_stride * vertex_index;

    brx_uint vertex_varying_buffer_offset = g_surface_vertex_varying_buffer_stride * vertex_index;

    brx_float3 vertex_position_model_space;
    {
        brx_uint3 packed_vector_vertex_position_binding = brx_byte_address_buffer_load3(g_surface_buffers[Deforming_Surface_Buffer_Vertex_Position_Index], vertex_position_buffer_offset);
    ...
    {
        brx_uint3 packed_vector_vertex_varying_binding = brx_byte_address_buffer_load3(g_surface_buffers[Deforming_Surface_Buffer_Vertex_Varying_Index], vertex_varying_buffer_offset);
    ...
    {
        brx_uint vertex_joint_buffer_offset = g_surface_vertex_blending_buffer_stride * vertex_index;
        brx_uint3 packed_vector_vertex_joint_buffer = brx_byte_address_buffer_load3(g_surface_buffers[Deforming_Surface_Buffer_Vertex_Blending_Index], vertex_joint_buffer_offset);
    ...
    brx_byte_address_buffer_store3(g_surface_instance_buffers[Deforming_Surface_Buffer_Instance_Vertex_Position_Index], vertex_position_buffer_offset, packed_vector_skined_vertex_position_binding);
    brx_byte_address_buffer_store3(g_surface_instance_buffers[Deforming_Surface_Buffer_Instance_Vertex_Varying_Index], vertex_varying_buffer_offset, packed_vector_skined_vertex_varying_binding);
}
