...
{
    brx_uint max_vertex_count = brx_byte_address_buffer_get_dimension(g_surface_buffers[0]) / g_vertex_position_buffer_stride;
    ...
    brx_float4 joint_weights;
    {
        ...
        brx_uint3 packed_vector_vertex_joint_buffer = brx_byte_address_buffer_load3(g_surface_buffers[2], vertex_joint_buffer_offset);
    ...
    brx_byte_address_buffer_store3(g_surface_instance_buffers[0], vertex_position_buffer_offset, packed_vector_skined_vertex_position_binding);
    brx_byte_address_buffer_store3(g_surface_instance_buffers[1], vertex_varying_buffer_offset, packed_vector_skined_vertex_varying_binding);
}
