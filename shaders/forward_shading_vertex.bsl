...
{
    brx_uint buffer_texture_flags = brx_byte_address_buffer_load(g_surface_buffers[FORWARD_SHADING_SURFACE_AUXILIARY_BUFFER_INDEX], 0);
    ...
    if(0u != (buffer_texture_flags & SURFACE_BUFFER_FLAG_UINT16_INDEX))
    {
        ...
        brx_uint packed_vector_index_buffer = brx_byte_address_buffer_load(g_surface_buffers[FORWARD_SHADING_SURFACE_INDEX_BUFFER_INDEX], index_buffer_offset);
    ...
    else
    {
        ...
        vertex_index = brx_byte_address_buffer_load(g_surface_buffers[FORWARD_SHADING_SURFACE_INDEX_BUFFER_INDEX], index_buffer_offset);
    }
    ...
    brx_float3 vertex_position_model_space;
    {
        ...
        brx_uint3 packed_vector_vertex_position_binding = brx_byte_address_buffer_load3(g_surface_buffers[FORWARD_SHADING_SURFACE_VERTEX_POSITION_BUFFER_INDEX], vertex_position_buffer_offset);
    ...
    brx_float2 vertex_texcoord;
    {
        ...
        brx_uint3 packed_vector_vertex_varying_binding = brx_byte_address_buffer_load3(g_surface_buffers[FORWARD_SHADING_SURFACE_VERTEX_VARYING_BUFFER_INDEX], vertex_varying_buffer_offset);
