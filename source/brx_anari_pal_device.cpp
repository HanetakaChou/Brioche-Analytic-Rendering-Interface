...
brx_anari_pal_device::brx_anari_pal_device()
    : m_device(NULL),
      ...
      m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update(NULL),
      m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update(NULL),
      m_diffuse_environment_lighting_sh_projection_pipeline_layout(NULL),
      ...
      m_diffuse_environment_lighting_sh_projection_clear_pipeline(NULL),
      m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline(NULL),
      m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline(NULL),
...
brx_anari_pal_device::~brx_anari_pal_device()
{
    ...
    assert(NULL == this->m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update);
    assert(NULL == this->m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update);
    assert(NULL == this->m_diffuse_environment_lighting_sh_projection_pipeline_layout);
    ...
    assert(NULL == this->m_diffuse_environment_lighting_sh_projection_clear_pipeline);
    assert(NULL == this->m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline);
    assert(NULL == this->m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline);
...
void brx_anari_pal_device::init(void *wsi_connection)
{
    ...
    // Scene Renderer
    {
        ...
        {
            brx_pal_descriptor_set_layout *diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update = NULL;
            ...
            {
                assert(NULL == diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update);
                BRX_PAL_DESCRIPTOR_SET_LAYOUT_BINDING const diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update_bindings[] = {
                    {0U, BRX_PAL_DESCRIPTOR_TYPE_SAMPLER, 1U}};
                diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update = this->m_device->create_descriptor_set_layout(sizeof(diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update_bindings) / sizeof(diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update_bindings[0]), diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update_bindings);

                assert(NULL == this->m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update);
                BRX_PAL_DESCRIPTOR_SET_LAYOUT_BINDING const diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update_bindings[] = {
                    {0U, BRX_PAL_DESCRIPTOR_TYPE_SAMPLED_IMAGE, 1U},
                    {1U, BRX_PAL_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1U}};
                this->m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update = this->m_device->create_descriptor_set_layout(sizeof(diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update_bindings) / sizeof(diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update_bindings[0]), diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update_bindings);

                assert(NULL == this->m_diffuse_environment_lighting_sh_projection_pipeline_layout);
                brx_pal_descriptor_set_layout *const diffuse_environment_lighting_sh_projection_pipeline_descriptor_set_layouts[] = {
                    diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update,
                    this->m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update};
                this->m_diffuse_environment_lighting_sh_projection_pipeline_layout = this->m_device->create_pipeline_layout(sizeof(diffuse_environment_lighting_sh_projection_pipeline_descriptor_set_layouts) / sizeof(diffuse_environment_lighting_sh_projection_pipeline_descriptor_set_layouts[0]), diffuse_environment_lighting_sh_projection_pipeline_descriptor_set_layouts);
            }

            // Environment Lighting SH Projection None Update Descriptor
            {
                assert(NULL == this->m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update);
                this->m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update = this->m_device->create_descriptor_set(diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update, 0U);
            }

            // Write Environment Lighting SH Projection None Update Descriptor
            {
                this->m_device->write_descriptor_set(this->m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update, 0U, BRX_PAL_DESCRIPTOR_TYPE_SAMPLER, 0U, 1U, NULL, NULL, NULL, NULL, NULL, NULL, &this->m_shared_none_update_set_sampler, NULL);
            }
            ...
            this->m_device->destroy_descriptor_set_layout(diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update);
            diffuse_environment_lighting_sh_projection_descriptor_set_layout_none_update = NULL;
...
#include "../shaders/spirv/deforming_compute.inl"
            ...
            // Environment Lighting SH Projection Pipeline
            {
                ...
                case BRX_PAL_BACKEND_NAME_D3D12:
                {
#include "../shaders/dxil/diffuse_environment_lighting_sh_projection_clear_compute.inl"
                    this->m_diffuse_environment_lighting_sh_projection_clear_pipeline = this->m_device->create_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_pipeline_layout, sizeof(diffuse_environment_lighting_sh_projection_clear_compute_shader_module_code), diffuse_environment_lighting_sh_projection_clear_compute_shader_module_code);
                }
                break;
                case BRX_PAL_BACKEND_NAME_VK:
                {
#include "../shaders/spirv/diffuse_environment_lighting_sh_projection_clear_compute.inl"
                    this->m_diffuse_environment_lighting_sh_projection_clear_pipeline = this->m_device->create_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_pipeline_layout, sizeof(diffuse_environment_lighting_sh_projection_clear_compute_shader_module_code), diffuse_environment_lighting_sh_projection_clear_compute_shader_module_code);
                }
                break;
                default:
                ...
                case BRX_PAL_BACKEND_NAME_D3D12:
                {
#include "../shaders/dxil/diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl"
                    this->m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline = this->m_device->create_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_pipeline_layout, sizeof(diffuse_environment_lighting_sh_projection_equirectangular_map_compute_shader_module_code), diffuse_environment_lighting_sh_projection_equirectangular_map_compute_shader_module_code);
                }
                break;
                case BRX_PAL_BACKEND_NAME_VK:
                {
#include "../shaders/spirv/diffuse_environment_lighting_sh_projection_equirectangular_map_compute.inl"
                    this->m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline = this->m_device->create_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_pipeline_layout, sizeof(diffuse_environment_lighting_sh_projection_equirectangular_map_compute_shader_module_code), diffuse_environment_lighting_sh_projection_equirectangular_map_compute_shader_module_code);
                }
                break;
                default:
                ...
                case BRX_PAL_BACKEND_NAME_D3D12:
                {
#include "../shaders/dxil/diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl"
                    this->m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline = this->m_device->create_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_pipeline_layout, sizeof(diffuse_environment_lighting_sh_projection_octahedral_map_compute_shader_module_code), diffuse_environment_lighting_sh_projection_octahedral_map_compute_shader_module_code);
                }
                break;
                case BRX_PAL_BACKEND_NAME_VK:
                {
#include "../shaders/spirv/diffuse_environment_lighting_sh_projection_octahedral_map_compute.inl"
                    this->m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline = this->m_device->create_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_pipeline_layout, sizeof(diffuse_environment_lighting_sh_projection_octahedral_map_compute_shader_module_code), diffuse_environment_lighting_sh_projection_octahedral_map_compute_shader_module_code);
                }
                break;
                default:
...
void brx_anari_pal_device::uninit()
{
    ...
    // Scene Renderer
    {
        // Render Pass and Pipeline
        {
            ...
            assert(NULL != this->m_diffuse_environment_lighting_sh_projection_clear_pipeline);
            this->m_device->destroy_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_clear_pipeline);
            this->m_diffuse_environment_lighting_sh_projection_clear_pipeline = NULL;

            assert(NULL != this->m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline);
            this->m_device->destroy_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline);
            this->m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline = NULL;

            assert(NULL != this->m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline);
            this->m_device->destroy_compute_pipeline(this->m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline);
            this->m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline = NULL;
        ...
        // Descriptor/Pipeline Layout and None Update Descriptor
        {
            ...
            {
                assert(NULL != this->m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update);
                this->m_device->destroy_descriptor_set(this->m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update);
                this->m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update = NULL;
            }

            // Environment Lighting SH Projection Descriptor/Pipeline Layout
            {
                assert(NULL != this->m_diffuse_environment_lighting_sh_projection_pipeline_layout);
                this->m_device->destroy_pipeline_layout(this->m_diffuse_environment_lighting_sh_projection_pipeline_layout);
                this->m_diffuse_environment_lighting_sh_projection_pipeline_layout = NULL;

                assert(NULL != this->m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update);
                this->m_device->destroy_descriptor_set_layout(this->m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update);
                this->m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update = NULL;
            }
