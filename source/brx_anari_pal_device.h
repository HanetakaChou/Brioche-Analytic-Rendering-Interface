...
class brx_anari_pal_device final : public brx_anari_device
{
	...
	// ---
	brx_pal_descriptor_set *m_diffuse_environment_lighting_sh_projection_descriptor_set_none_update;
	brx_pal_descriptor_set_layout *m_diffuse_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update;
	brx_pal_pipeline_layout *m_diffuse_environment_lighting_sh_projection_pipeline_layout;
	// ---
	...
	// ---
	brx_pal_compute_pipeline *m_diffuse_environment_lighting_sh_projection_clear_pipeline;
	brx_pal_compute_pipeline *m_diffuse_environment_lighting_sh_projection_equirectangular_map_pipeline;
	brx_pal_compute_pipeline *m_diffuse_environment_lighting_sh_projection_octahedral_map_pipeline;
	// ---
