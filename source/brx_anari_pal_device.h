...
class brx_anari_pal_device final : public brx_anari_device
{
	...
	// ---
	brx_pal_descriptor_set_layout *m_environment_lighting_sh_projection_descriptor_set_layout_per_environment_lighting_update;
	brx_pal_pipeline_layout *m_environment_lighting_sh_projection_pipeline_layout;
	// ---
	brx_pal_uniform_upload_buffer *m_environment_lighting_skybox_none_update_set_uniform_buffer;
	brx_pal_descriptor_set *m_environment_lighting_skybox_descriptor_set_none_update;
	brx_pal_descriptor_set_layout *m_environment_lighting_skybox_descriptor_set_layout_per_environment_lighting_update;
	brx_pal_pipeline_layout *m_environment_lighting_skybox_pipeline_layout;
	// ---
	...
	brx_pal_descriptor_set_layout *m_forward_shading_descriptor_set_layout_per_environment_lighting_update;
	...
	brx_pal_graphics_pipeline *m_environment_lighting_skybox_pipeline;
	...
	brx_pal_descriptor_set *m_hdri_light_environment_lighting_sh_projection_descriptor_set_per_environment_lighting_update;
	brx_pal_uniform_upload_buffer *m_hdri_light_environment_lighting_skybox_per_environment_lighting_update_set_uniform_buffer;
	brx_pal_descriptor_set *m_hdri_light_environment_lighting_skybox_descriptor_set_per_environment_lighting_update;
	brx_pal_uniform_upload_buffer *m_hdri_light_forward_shading_per_environment_lighting_update_set_uniform_buffer;
	brx_pal_descriptor_set *m_hdri_light_forward_shading_descriptor_set_per_environment_lighting_update;
...
public:
	...
	brx_pal_descriptor_set *create_environment_lighting_sh_projection_per_environment_lighting_descriptor_set(brx_pal_sampled_image const *const radiance, brx_pal_storage_buffer const *const irradiance_coefficients);
	...
	brx_pal_descriptor_set *create_environment_lighting_skybox_per_environment_lighting_descriptor_set(brx_pal_uniform_upload_buffer const *const uniform_buffer, brx_pal_sampled_image const *const radiance);
	brx_pal_descriptor_set *create_forward_shading_per_environment_lighting_descriptor_set(brx_pal_uniform_upload_buffer const *const uniform_buffer, brx_pal_read_only_storage_buffer const *const irradiance_coefficients);
	...
	void render_hdri_light_sh_projection(brx_pal_graphics_command_buffer *graphics_command_buffer);
