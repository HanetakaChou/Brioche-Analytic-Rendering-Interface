...
#include "../shaders/dxil/environment_lighting_sh_projection_clear_compute.inl"
            this->m_environment_lighting_sh_projection_clear_pipeline = this->m_device->create_compute_pipeline(this->m_environment_lighting_pipeline_layout, sizeof(environment_lighting_sh_projection_clear_compute_shader_module_code), environment_lighting_sh_projection_clear_compute_shader_module_code);
        }
        break;
...
#include "../shaders/dxil/environment_lighting_sh_projection_equirectangular_map_compute.inl"
            this->m_environment_lighting_sh_projection_equirectangular_map_pipeline = this->m_device->create_compute_pipeline(this->m_environment_lighting_pipeline_layout, sizeof(environment_lighting_sh_projection_equirectangular_map_compute_shader_module_code), environment_lighting_sh_projection_equirectangular_map_compute_shader_module_code);
        }
        break;
        case BRX_PAL_BACKEND_NAME_VK:
        {
...
#include "../shaders/dxil/environment_lighting_sh_projection_octahedral_map_compute.inl"
            this->m_environment_lighting_sh_projection_octahedral_map_pipeline = this->m_device->create_compute_pipeline(this->m_environment_lighting_pipeline_layout, sizeof(environment_lighting_sh_projection_octahedral_map_compute_shader_module_code), environment_lighting_sh_projection_octahedral_map_compute_shader_module_code);
        }
        break;
        case BRX_PAL_BACKEND_NAME_VK:
        {
    ...
    if (this->m_hdri_light_dirty)
    {
        ...
        if ((NULL != this->m_hdri_light_radiance) && ((BRX_ANARI_HDRI_LIGHT_LAYOUT_EQUIRECTANGULAR == hdri_light_layout) || (BRX_ANARI_HDRI_LIGHT_LAYOUT_OCTAHEDRAL == hdri_light_layout)))
        {
...

            {
                ...
                DirectX::XMUINT3 environment_lighting_sh_projection_dispatch_extent = brx_environment_lighting_sh_projection_dispatch_extent(hdri_light_radiance_size);

                graphics_command_buffer->dispatch(environment_lighting_sh_projection_dispatch_extent.x, environment_lighting_sh_projection_dispatch_extent.y, environment_lighting_sh_projection_dispatch_extent.z);
            }
        }
