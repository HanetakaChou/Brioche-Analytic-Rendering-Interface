...
inline brx_pal_sampled_asset_image *brx_anari_pal_device::internal_create_asset_image(BRX_ANARI_IMAGE_FORMAT const origin_format, void const *const origin_pixel_data, uint32_t const origin_width, uint32_t const origin_height)
{
    // TODO: batch
...
inline void brx_anari_pal_device::internal_destroy_asset_image(brx_pal_sampled_asset_image *const image)
{
#ifndef NDEBUG
...
inline brx_anari_pal_image::brx_anari_pal_image() : m_ref_count(0U), m_image(NULL)
{
}
...
inline void brx_anari_pal_image::init(brx_anari_pal_device *device, BRX_ANARI_IMAGE_FORMAT format, void *pixel_data, uint32_t width, uint32_t height)
{
    assert(0U == this->m_ref_count);
    this->m_ref_count = 1U;
